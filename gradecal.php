...
<body style="background-image: url(cry.png); background-size: 100%; background-repeat: no-repeat;">
	<nav class="navbar navbar-default">
		  		<div class="container-fluid">
		    		<div class="navbar-header">
		      			<a class="navbar-brand" href="aboutus.php"><span>EDDY HIGH TESTS</span></a>
		    		</div>
		    			<ul class="nav navbar-nav">
		      				<li class="active"><a href="cat.php">Home</a></li>
		      				<li><a href="gradecal.php">Get Results</a></li>
		    			</ul>
	...
	<h3 style="text-align: center;"><B>Please enter your marks!:</B></h3>
	<form class="form-group" style="text-align: center;" method="GET">
		...
		<br>
		<br>
		<button style="text-align: center;" class="btn btn-success">ENTER</button>
		<br>
		<?php
